...
function TerminalWidget() {
  return (
    <div className="w-full rounded-2xl bg-zinc-950/95 text-emerald-400 font-mono text-xs border border-emerald-500/10 dark:border-emerald-500/20 shadow-[0_15px_40px_-15px_rgba(16,185,129,0.15)] dark:shadow-[0_15px_40px_-15px_rgba(0,0,0,0.6)] p-5 overflow-hidden relative backdrop-blur-md">
      ...
      <div className="space-y-2 leading-relaxed">
        ...
        <div className="pl-3 text-zinc-300 space-y-1">
  ...
  return (
    <main className="flex flex-col min-h-[100dvh] space-y-16 sm:space-y-24 pb-20">
      ...
      <section id="hero" className="w-full pt-4">
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_260px] gap-6 xl:gap-8 items-center">

          {/* Col 1: Profile Portrait */}
          <BlurFade delay={BLUR_FADE_DELAY} className="flex justify-center lg:justify-start order-1">
            <div className="relative group">
              {/* Outer ambient glow */}
              <div className="absolute -inset-5 rounded-full bg-emerald-500/10 blur-2xl group-hover:bg-emerald-500/20 transition-all duration-700 pointer-events-none" />
          ...
          <div className="space-y-4 order-2">
            ...
            <BlurFade delay={BLUR_FADE_DELAY * 3} className="flex flex-col gap-2 pt-1">
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-xs font-mono text-emerald-400 hover:text-emerald-300 hover:underline transition-colors w-fit"
              >
        ...
        <BlurFade delay={BLUR_FADE_DELAY * 14}>
          <div className="cyber-glow-card rounded-3xl p-8 sm:p-12 text-center relative overflow-hidden border border-black/[0.04] dark:border-white/[0.05] dark:border-emerald-500/10 max-w-4xl mx-auto shadow-xl group">
            ...
            <div className="space-y-4 relative z-10">
              ...
              <div className="pt-4 flex justify-center items-center gap-4 text-xs font-mono text-muted-foreground select-none">
